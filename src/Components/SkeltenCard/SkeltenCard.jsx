...
const SkeltenCard = () => {
  return (
    ...
    <div className="mt-2">
     ...
     <div className='bg-gray-300 mt-4 h-2'></div>
     <div className='bg-gray-300 mt-2 h-2'></div>
     <div className='bg-gray-300 mt-2 h-2'></div>
     <div className='bg-gray-300 mt-2 h-2'></div>
     <div className='bg-gray-300 mt-2 h-2'></div>
     <div className='bg-gray-300 mt-2 h-10 w-12'></div>

     <div className='bg-gray-300 mt-4 h-10 rounded-md '></div>
